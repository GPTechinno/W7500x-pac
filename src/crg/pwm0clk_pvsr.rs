#[doc = "Register `PWM0CLK_PVSR` reader"]
pub struct R(crate::R<PWM0CLK_PVSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM0CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM0CLK_PVSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM0CLK_PVSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWM0CLK_PVSR` writer"]
pub struct W(crate::W<PWM0CLK_PVSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM0CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM0CLK_PVSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM0CLK_PVSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct PCPS_R(crate::FieldReader<u8>);
impl PCPS_R {
    #[inline(always)]
...
#[doc = "PWM0CLK prescale value select register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm0clk_pvsr](index.html) module"]
pub struct PWM0CLK_PVSR_SPEC;
impl crate::RegisterSpec for PWM0CLK_PVSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm0clk_pvsr::R](R) reader structure"]
impl crate::Readable for PWM0CLK_PVSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm0clk_pvsr::W](W) writer structure"]
impl crate::Writable for PWM0CLK_PVSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWM0CLK_PVSR to value 0"]
impl crate::Resettable for PWM0CLK_PVSR_SPEC {
    #[inline(always)]
