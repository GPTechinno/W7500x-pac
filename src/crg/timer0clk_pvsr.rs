#[doc = "Register `TIMER0CLK_PVSR` reader"]
pub struct R(crate::R<TIMER0CLK_PVSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TIMER0CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TIMER0CLK_PVSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TIMER0CLK_PVSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TIMER0CLK_PVSR` writer"]
pub struct W(crate::W<TIMER0CLK_PVSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TIMER0CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TIMER0CLK_PVSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TIMER0CLK_PVSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct TCPS_R(crate::FieldReader<u8, TCPS_A>);
impl TCPS_R {
...
impl core::ops::Deref for TCPS_R {
    type Target = crate::FieldReader<u8, TCPS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    ...
    pub fn tcps(&self) -> TCPS_R {
        TCPS_R::new((self.bits & 0x07) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - TIMERnCLK prescale value select bits"]
...
#[doc = "TIMER0CLK prescale value select register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [timer0clk_pvsr](index.html) module"]
pub struct TIMER0CLK_PVSR_SPEC;
impl crate::RegisterSpec for TIMER0CLK_PVSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [timer0clk_pvsr::R](R) reader structure"]
impl crate::Readable for TIMER0CLK_PVSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [timer0clk_pvsr::W](W) writer structure"]
impl crate::Writable for TIMER0CLK_PVSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TIMER0CLK_PVSR to value 0"]
impl crate::Resettable for TIMER0CLK_PVSR_SPEC {
    #[inline(always)]
