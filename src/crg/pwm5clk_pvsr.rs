#[doc = "Register `PWM5CLK_PVSR` reader"]
pub struct R(crate::R<PWM5CLK_PVSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM5CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWM5CLK_PVSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWM5CLK_PVSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWM5CLK_PVSR` writer"]
pub struct W(crate::W<PWM5CLK_PVSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWM5CLK_PVSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWM5CLK_PVSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWM5CLK_PVSR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct PWM5CLK_PVSR_SPEC;
impl crate::RegisterSpec for PWM5CLK_PVSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm5clk_pvsr::R](R) reader structure"]
impl crate::Readable for PWM5CLK_PVSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwm5clk_pvsr::W](W) writer structure"]
impl crate::Writable for PWM5CLK_PVSR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWM5CLK_PVSR to value 0"]
impl crate::Resettable for PWM5CLK_PVSR_SPEC {
    #[inline(always)]
