...
#[doc = "Field `CHNL_PRI_ALT_CLR` writer - Set the appropriate bit to select the primary data structure for the corresponding DMA channel"]
pub struct CHNL_PRI_ALT_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CHNL_PRI_ALT_CLR_W<'a> {
...
impl W {
    #[doc = "Bits 0:5 - Set the appropriate bit to select the primary data structure for the corresponding DMA channel"]
    #[inline(always)]
    pub fn chnl_pri_alt_clr(&mut self) -> CHNL_PRI_ALT_CLR_W {
        CHNL_PRI_ALT_CLR_W { w: self }
    }
