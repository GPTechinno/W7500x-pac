...
#[doc = "Field `CHNL_REQ_MASK_CLR` writer - CHNL_REQ_MASK_CLR\\[5:0\\]
...
pub struct CHNL_REQ_MASK_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> CHNL_REQ_MASK_CLR_W<'a> {
...
impl W {
    #[doc = "Bits 0:5 - CHNL_REQ_MASK_CLR\\[5:0\\]
bits (Set the appropriate bit to enable DMA requests for the channel corresponding to dma_req\\[Channel-1\\]
and dma_sreq\\[Channel-1\\])"]
    #[inline(always)]
    pub fn chnl_req_mask_clr(&mut self) -> CHNL_REQ_MASK_CLR_W {
        CHNL_REQ_MASK_CLR_W { w: self }
    }
