...
#[doc = "Field `BAUDDIV` writer - Baud rate divider"]
pub struct BAUDDIV_W<'a> {
    w: &'a mut W,
}
impl<'a> BAUDDIV_W<'a> {
...
impl R {
    #[doc = "Bits 0:19 - Baud rate divider"]
    #[inline(always)]
    pub fn bauddiv(&self) -> BAUDDIV_R {
        BAUDDIV_R::new((self.bits & 0x000f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:19 - Baud rate divider"]
    #[inline(always)]
    pub fn bauddiv(&mut self) -> BAUDDIV_W {
        BAUDDIV_W { w: self }
    }
