...
#[doc = "Field `ILPDVSR` reader - low-power divisor value"]
pub struct ILPDVSR_R(crate::FieldReader<u8>);
impl ILPDVSR_R {
    #[inline(always)]
...
#[doc = "Field `ILPDVSR` writer - low-power divisor value"]
...
impl R {
    #[doc = "Bits 0:7 - low-power divisor value"]
    #[inline(always)]
